...
public class Game implements Generational<Game, Grid>, Countable, Renderable {
    ...
    /**
     * Method to get a very crude measure of growth rate based on this Game and
    ...
    /**
     * Factory method to create a new Game starting at the given generation and
    ...
    public static class Behavior {
        ...
        /**
         * The reason the run stopped: 0: the cells went extinct 1: a repeating
         * sequence was noted; 2: the maximum configured number of generations
         * was reached.
         */
     ...
     * <p>
     * NOTE this method of checking for cycles is not guaranteed to work! NOTE
     * this method may be very inefficient.
     * <p>
     ...
     * @return a MatchingGame object: if the match field is null it means that
     * we did not find a match; the k field is the number of generations between
     * game and the matching game.
     */
